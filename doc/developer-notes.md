...
Pmc is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 19901.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 19900 for connections and services them.
...
However, in open source software such as Pmc, where everyone uses
...
pay attention to for reviewers of Pmc code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Pmc uses tinyformat, which is type safe. Leave them out to avoid confusion
