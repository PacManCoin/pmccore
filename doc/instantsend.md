...
This mechanism has been integrated into Bitcore-Node-Pmc which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PacManCoin/insight-api-pmc#web-socket-api](https://github.com/PacManCoin/insight-api-pmc#web-socket-api)
* API: [https://github.com/PacManCoin/insight-api-pmc#instantsend-transactions](https://github.com/PacManCoin/insight-api-pmc#instantsend-transactions)
...
By default, the Pmc daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pmc daemon:
