...
Only requiring some minor changes is pmc.cpp.
...
Changes to pmc.cpp
----------------------
pmc.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
