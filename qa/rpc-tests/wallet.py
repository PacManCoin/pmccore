...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 PMC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 5000 PMC in block rewards plus fees, but
        ...
        # Send 100 PMC with subtract fee from amount
        ...
        # Sendmany 100 PMC with subtract fee from amount
