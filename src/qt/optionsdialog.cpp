    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PMC-light"), QVariant("light"));
    ui->theme->addItem(QString("PMC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("PMC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PMC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PMC-traditional"), QVariant("trad"));
