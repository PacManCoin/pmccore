...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pmc address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pmc: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Pmc"), this);
    aboutAction->setStatusTip(tr("Show information about Pmc"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pmc"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pmc addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pmc addresses"));
    ...
    openAction->setStatusTip(tr("Open a pmc: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pmc help message to get a list with possible Pmc command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Pmc client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pmc network", "", count));
    } else {
...
{
    QString strTitle = tr("Pmc"); // default title
