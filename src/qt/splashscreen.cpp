    ...
    QWidget(0, f), curAlignment(0)
{
	...
	QString copyrightTextPmc   = QChar(0xA9)+QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Pmc developers"));
	...
	pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+24,copyrightTextPmc);
