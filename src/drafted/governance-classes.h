 ...
 *
 *   // network
 *   CPmcNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.pacmancoin.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPmcNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: PmcNetwork
// //   -- signature requirements : Key1(User)
// class CPmcNetworkVariable : public CGovernanceObject
// {
// private:
